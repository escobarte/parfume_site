/**
 * Денормализация вариантов товара (PLAN.md §4.1).
 * minPrice / maxPrice / inStock руками не заполняются — только этой функцией
 * из хука beforeChange коллекции products.
 */
