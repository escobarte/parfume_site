...
export default buildConfig({
  admin: {
    ...
    // Уведомления о сохранении (баг приёмки 2026-08-23): дефолтный тост
    // Payload висит 4с в правом нижнем углу и на широком мониторе просто не
    // попадает в поле зрения — владелец не понимал, сохранилась ли запись.
    // Позиция и длительность — штатные опции конфига (не патч и не подмена
    // внутренних компонентов), размер/контраст — в src/app/(payload)/custom.scss.
    toast: {
      position: 'top-center',
      duration: 6000,
    },
